...
class MapWithMarkerClustering extends StatefulWidget {
  const MapWithMarkerClustering({super.key});

  @override
  State<MapWithMarkerClustering> createState() =>
      MapWithMarkerClusteringState();
}

class MapWithMarkerClusteringState extends State<MapWithMarkerClustering> {
